...
import backgroundImage from "../../../assets/back.jpg"; // Adjust the path as needed
const HeroSection = () => {
    ...
    >
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <span style={{ color: "#1E90FF" }}>RoomMate</span>
        </Typography>
        <Typography
          variant="h4"
          sx={{
        ...
        >
          <Typewriter
            words={[
              "Effortless Management for Students, Wardens, and Chief Wardens",
              "Your Hostel, Your Rules, Our Management",
              "A Smarter Way to Live and Manage Hostel Life",
              "Transparency and Accountability for a Better Hostel Experience",
            ]}
            loop={true}
            cursor
            cursorStyle="_"
        ...
        >
          Wanna Try? Just click the button below and start exploring!
        </Typography>
      </Container>
