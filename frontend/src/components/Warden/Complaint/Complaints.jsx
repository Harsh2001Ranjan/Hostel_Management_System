...
//   //     setShowIgnoreReason((prev) => ({ ...prev, [complaintId]: true }));
//   //   };

//   //   const handleEscalateClick = (complaintId) => {
//   //     setShowEscalateReason((prev) => ({ ...prev, [complaintId]: true }));
//   //   };
//   const handleIgnoreClick = (complaintId) => {
...
//                   <Button
//                     variant="contained"
//                     sx={{ bgcolor: "blue", color: "#fff", mr: 1 }}
//                     onClick={() =>
...
//                   <Button
//                     variant="contained"
//                     sx={{ bgcolor: "green", color: "#fff", mr: 1 }}
//                     onClick={() =>
